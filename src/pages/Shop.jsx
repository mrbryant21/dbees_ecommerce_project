...
const Shop = () => {
  ...
  const [activeFilter, setActiveFilter] = useState(null); // 'age', 'gender', 'sort', or null
  ...
  return (
    <div className="min-h-screen">
      <div className="productsPageBanner max-w-7xl mx-auto h-48 md:h-84 overflow-hidden relative mt-8 rounded-2xl shadow-md">
        <img className="object-center object-cover w-full h-full" src="/images/homepage_banner_1.png" alt="Shop Banner" />
      </div>
