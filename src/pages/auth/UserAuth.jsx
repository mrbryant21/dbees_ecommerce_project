      ...
      <div className="flex flex-col justify-center items-center p-6 sm:p-12 bg-white relative">
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <form className="space-y-4">
            ...
            <button className="w-full bg-gray-900 text-white font-bold py-3.5 rounded-xl hover:bg-pink-600 hover:shadow-lg hover:shadow-pink-500/30 transition-all duration-300 flex items-center justify-center gap-2 mt-6 cursor-pointer">
